...
int main(void) {
  ...
  /* USER CODE BEGIN 2 */
  eleclock =
      Clock(&huart1, HOUR_T_CS_GPIO_Port, HOUR_T_CS_Pin, HOUR_O_CS_GPIO_Port,
            HOUR_O_CS_Pin, MIN_T_CS_GPIO_Port, MIN_T_CS_Pin, MIN_O_CS_GPIO_Port,
            MIN_O_CS_Pin, SEC_T_CS_GPIO_Port, SEC_T_CS_Pin, SEC_O_CS_GPIO_Port,
            SEC_O_CS_Pin);
  eleclock.Init();
